...
static int ov5693_s_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_EXPOSURE:
		// TEMPARARY: Set exposure to 0 to make sure image is captured
		ret = ov5693_write_reg(client,
				OV5693_8BIT, OV5693_EXPOSURE_H, 0);
		ret = ov5693_write_reg(client,
				OV5693_8BIT, OV5693_EXPOSURE_M, 0);
		ret = ov5693_write_reg(client,
				OV5693_8BIT, OV5693_EXPOSURE_L, 0);
		break;
	default:
		ret = -EINVAL;
	}
...
static int __ov5693_power_on(struct ov5693_device *ov5693)
{
	...
	// TODO: According to DS, only one of XSHUTDN and PWDNB is actually
	// controlled by GPIO. The other is tied to DOVDD.
	...
	/*gpiod_set_value_cansleep(ov5692->led_gpio, 1);*/
...
#define OV5693_LINK_FREQ_160MHZ		160000000
#define OV5693_PIXEL_RATE			(OV5693_LINK_FREQ_160MHZ * 2 * 2) / 10
static const s64 link_freq_menu_items[] = {
	OV5693_LINK_FREQ_160MHZ
};
...
static int ov5693_init_controls(struct ov5693_device *dev)
{
	...
	ctrl = v4l2_ctrl_new_std(handler, &ctrl_ops,
					     V4L2_CID_EXPOSURE,
					     4, /* Exposure min */
					     OV5693_MAX_EXPOSURE_VALUE, /* Exposure max */
						 1, /* Exposure step */
					     OV5693_MAX_EXPOSURE_VALUE /* Exposure max */);
